...
aes.exe --enc -p test -m ctr -l 128 README.md tmp/encrypt.enc
aes.exe --dec -p test -m ctr -l 128 tmp/encrypt.enc tmp/result.md
fc /n README.md tmp/result.md

echo "test 192-bit, CTR"
aes.exe --enc -p test -m ctr -l 192 README.md tmp/encrypt.enc
aes.exe --dec -p test -m ctr -l 192 tmp/encrypt.enc tmp/result.md
fc /n README.md tmp/result.md

echo "test 256-bit, CTR"
aes.exe --enc -p test -m ctr -l 256 README.md tmp/encrypt.enc
aes.exe --dec -p test -m ctr -l 256 tmp/encrypt.enc tmp/result.md
fc /n README.md tmp/result.md
